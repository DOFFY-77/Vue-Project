        ...
        <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
            <form @submit.prevent="handleSubmit">
                ...
                <div class="mb-4">
                    ...
                    <select id="type" v-model="form.type" name="type" class="border rounded w-full py-2 px-3" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="contact_email" v-model="form.company.contactEmail" name="contact_email" class="border rounded w-full py-2 px-3" placeholder="Email address for applicants" required />
                </div>
                <div class="mb-4">
